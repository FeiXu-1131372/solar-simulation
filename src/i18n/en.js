export default {
ui: {
    'pageTitle': 'Moon: Synchronous Rotation Explained',
    'solarSystem': '🌌 Solar System',
    'syncRotation': 'Sync Rotation',
    'paused': 'Paused',
    'labels': 'Labels',
    'galaxy': 'Galaxy',
    ...
    'speed': 'Speed',
    'view': 'View',
    'galaxyViewBtn': '🌌 Galaxy View &nbsp;↔&nbsp; 🪐 Solar',
    'resetView': '⟲ Reset View',
    'facingEarth': 'Facing Earth',
    'darkSide': 'Dark Side',
    ...
    'tabLearn': '🧠 Learn',
    'tabExplore': '🚀 Explore',
    'learnIntro': 'Tap a question you\'re curious about 👇',
    'realMission': '🚀 Real Mission',
    ...
    'tap': '👆 TAP!',
    'lives': 'Lives:',
    'hazardHint': 'Press ↑↓ or tap top/bottom half to dodge',
    'controlIntro': 'Click a system when it flashes to boost it!',
    'missionLost': 'Mission Lost',
    'relaunchMission': '🚀 Relaunch Mission',
    'closeBtn': '✕ Close',
    'active': '🟢 Active',
    'planned': '🟡 Planned',
    'historical': '⚪ Historical',
    'launchBang': 'Launch! 🚀',
    'launchingTo': 'Launching to {name}',
    'liftoff': 'LIFTOFF!',
    'gauntlet': '🏁 GAUNTLET',
    'hazardRun': '🕹️ HAZARD RUN',
    'missionControl': '📡 MISSION CONTROL',
    'arrivedAt': '{name} has arrived at {name2}!',
    'missionSubtitle': '{name} · {name2} · {year}',
    'realFactLabel': '<strong>Real fact:</strong>',
    'stageTitle': '{icon} Stage {i}: {name}',
    'chooseMissionCount': '🚀 Choose Mission ({count})',
    ...
    'shields': 'Shields',
    'comms': 'Comms',
    'fuelDepleting': 'Fuel depleting!',
    'powerFailing': 'Power failing!',
    'shieldsDropping': 'Shields dropping!',
    ...
    'htpSlingshotTitle': 'Gravity Slingshot',
    'htpSlingshotS1': '<strong>Drag from the yellow probe</strong> — pull back like a slingshot to set direction and power.',
    'htpSlingshotS2': '<strong>Use planet gravity</strong> — fly near the glowing planets to curve your trajectory.',
    'htpSlingshotS3': '<strong>Hit the green target</strong> on the right edge. You have 3 attempts.',
    'htpSlingshotS4': 'The dotted line shows your predicted path — adjust your aim before releasing!',
    'htpDockingTitle': 'Space Docking',
    'htpDockingS1': '<strong>Your ship is drifting in zero-g</strong> — gravity pulls it down toward the planet.',
    'htpDockingS2': '<strong>Thrust UP</strong>: hold the bottom half of the screen, or press <strong>Space / ↑</strong>.',
    'htpDockingS3': '<strong>Steer left/right</strong>: tap the left or right edge of the screen, or press <strong>← →</strong>.',
    'htpDockingS4': '<strong>Dock gently</strong> — align with the blinking port on the station and arrive slowly. Too fast = crash!',
    'htpAsteroidTitle': 'Asteroid Field',
    'htpAsteroidS1': 'Your ship flies <strong>automatically</strong> through 5 lanes. Asteroids come from the right.',
    'htpAsteroidS2': '<strong>Tap the top half</strong> to move up, <strong>tap the bottom half</strong> to move down. Or swipe up/down.',
    'htpAsteroidS3': 'On desktop use <strong>↑ ↓ arrow keys</strong> or <strong>W / S</strong>.',
    'htpAsteroidS4': 'Collect <strong>stars</strong> for bonus points. You have 3 shields — survive 25 seconds to win!',
    'htpMemoryTitle': 'Orbital Memory',
    'htpMemoryS1': '10 cards orbit around the center — they keep <strong>moving while you play!</strong>',
    'htpMemoryS2': '<strong>Tap a card</strong> to flip it and reveal its symbol.',
    'htpMemoryS3': 'Tap a <strong>second card</strong> — if symbols match, they stay revealed. If not, both flip back.',
    'htpMemoryS4': 'Match all <strong>5 pairs</strong> before the timer runs out. Track the cards as they orbit!',
    'htpLanderTitle': 'Lunar Lander',
    'htpLanderS1': 'Your lander falls under <strong>planet gravity</strong> — each world pulls differently!',
    'htpLanderS2': '<strong>Thrust UP</strong>: hold the bottom half of the screen, or hold <strong>Space / ↑</strong>.',
    'htpLanderS3': '<strong>Steer</strong>: tap left/right edges of screen, or press <strong>← →</strong> keys.',
    'htpLanderS4': 'Land <strong>gently on the green zone</strong>. Watch your speed — if you hit too fast, you crash!',
    'htpHazardTitle': 'Hazard Run',
    'htpHazardS1': 'Your ship flies through <strong>3 lanes</strong>. Hazards come from the right!',
    'htpHazardS2': '<strong>Tap top half</strong> to move up, <strong>tap bottom half</strong> to move down.',
    'htpHazardS3': 'On desktop use <strong>↑ ↓ arrow keys</strong> or <strong>W / S</strong>.',
    'htpHazardS4': 'You have <strong>3 lives</strong> — dodge hazards and survive to complete the mission!',
    'htpControlTitle': 'Mission Control',
    'htpControlS1': 'Keep <strong>4 systems online</strong>: Fuel, Power, Shields, and Comms.',
    'htpControlS2': 'Systems <strong>drain over time</strong> — click a system when it flashes to boost it!',
    'htpControlS3': 'Watch for <strong>crisis events</strong> that drain systems faster.',
    'htpControlS4': 'Keep all systems above zero for <strong>25 seconds</strong> to complete the mission!',
},
...
celestialFacts: {
    ...
    'Mars': {
        ...
        explore: {
            ...
            whatif: '<strong>What if you sneezed on Mars?</strong> The CO₂ air is unbreathable, it\'s freezing, and intense UV radiation would hit you immediately — there\'s no ozone layer. Even stepping outside requires a full spacesuit. Your sneeze cloud would drift far in the thin air, then settle as red dust.',
        },
        game: {
